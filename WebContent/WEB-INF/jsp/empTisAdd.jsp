		...
		<div class="tCright">
			...
			<div class="motai"id = "div2">
				 <div style="height: 300px">
							...
							<form action="${pageContext.request.contextPath }/Tis/addTis.emp" method="post" onsubmit="return gggT()">
						     	<div class="bt"><button class="btn btn-default" type="submit">提交 </button></div>
								<div>
									<!-- 主题id -->

									 <label class="form-label" for="nameRoEmail">贴士名称:</label>
		                            <input class="form-control " type="text"  id="atisName" name="tisName" value="" placeholder="贴士名称" >
		                            <label class="form-label" for="nameRoEmail">贴士内容:</label>
						     		<textarea id="container" name="tisContent">请输入内容</textarea>
								</div>
						 	</form>
						</div> 
			</div>
