	...
	var item = {
		toolbars : [
				[ 'fullscreen', 'undo', 'redo', 'bold', 'italic', 'underline',
						...
						'simpleupload', 'insertvideo', 'lineheight',
	...
	<div class="bgcc">
		...
		<div class="tContent">
			...
			<div class="tCright">
				...
				<ol class="breadcrumb">
					<li id="uuOne">消息管理</li>
					<li id="uuTwo" class="active">留言回复</li>
				</ol>
				<!-- 查询条 -->
				<div class="head1">
					<div>
				...
				<div class="mainbody" id="div1">
					<c:forEach items="${list }" var="building">
						<div class="main">
							<div class="mainleft">来自：${building.sender }&nbsp;&nbsp;&nbsp;&nbsp;内容：</div>
							<div class="mainright">${building.buildingV }</div>
					...
					<div class="motai" id="div2">
						<div style="height: 300px">
							...
							<form
								action="${pageContext.request.contextPath}/building/addBuilding1.emp"
								method="post">
								<div class="bt">
								...
								<div>
									<!-- 主题id -->
									<input name="themeId" value="${themeId }" type="hidden"
										style="width: 95%">
				...
				<div class="text-center">
					<nav aria-label="Page navigation">
						<ul class="pagination">
							<li <c:if test="${page==1}">disabled</c:if>><a
								<c:if test="${page!=1}"> href="${pageContext.request.contextPath}/building/selBuilding.emp?page=${page-1}&id=${themeId }&flag=2" </c:if>>&laquo;
							</a></li>
							<c:if test="${begin!=1 }">
								<li><a>...</a></li>
							</c:if>
							<c:forEach var="i" begin="${begin}" end="${end}">
								<li <c:if test="${i==page }">class="active"</c:if>><a
									href="${pageContext.request.contextPath}/building/selBuilding.emp?page=${i}&id=${themeId }&flag=2">${i}${flag }</a></li>
							</c:forEach>
							<c:if test="${end!=pages }">
								<li><a>...</a></li>
							</c:if>
							<li <c:if test="${page==pages}">disabled</c:if>><a
								<c:if test="${page!=pages}"> href="${pageContext.request.contextPath}/building/selBuilding.emp?page=${page+1}&id=${themeId }&flag=2" </c:if>>
									&raquo;</a></li>
