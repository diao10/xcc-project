...
<body class="body_index">
	...
	<div id="navigation">
		<table cellspacing="1" cellpadding="0" align="center">
			<tr>
				...
				<td><a href="${pageContext.request.contextPath }/mobile/jkzjList.jsp" class="current">专家团队</a></td>
				...
				$.ajax({
					...
					success:function(data){
						...
						for (var i = 0; i < data.list.length; i++) {
							...
							htmlVal += "<li><div class='left'><p><img src='${pageContext.request.contextPath }/"+docc.imgid+"' align='top'>"+
							"<span>"+docc.doctorName+"</span><br><span>"+docc.jobs+"</span><br><span>"+docc.description+"</span><br></div></li>";
						}
						$('#newlist').html(htmlVal);
					}
				});	
			});
		</script>
	...
	<!--当前位置开始-->
	<div id="location">
		<a href="${pageContext.request.contextPath }/mobile/index.jsp">网站首页</a>><a class="current_channel" href="#">专家团队</a>
	</div>
	<!--当前位置结束-->
	<div class="article">
		...
		<div class="left_body">
			...
			<ul class="textlist" id="newlist">
				<!--循环开始-->
				<li><div class="left"><p><img src="${pageContext.request.contextPath }/dist/img/touxiangTest.png" align="top"><span>123</span><br><span>123</span><br><span>123</span><br></div></li>
				<!--循环结束-->
			</ul>
			<!-- 文本样式 列表结束--->
			<div class="clear"></div>
